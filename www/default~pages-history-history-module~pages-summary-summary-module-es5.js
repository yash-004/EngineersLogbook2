(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-history-history-module~pages-summary-summary-module"], {
  ...
  /***/
  function node_modulesChartjsChartRadialGaugeBuildChartRadialGaugeCjsJs(module, exports, __webpack_require__) {
    "use strict";
    ...
    Chart.elements.RoundedArc = Chart.elements.Arc.extend({
      draw: function draw() {
        ...
        var cornerX = (vm.outerRadius + vm.innerRadius) / 2; // translate + rotate to make drawing the corners simpler
    ...
    var RadialGaugeController = function RadialGaugeController(Chart$$1) {
      Chart$$1.controllers.radialGauge = Chart$$1.DatasetController.extend({
        ...
        drawCenterText: function drawCenterText(_ref3) {
          ...
          var textX = Math.round(-textWidth / 2); // only display the text if it fits
    ...
    var RadialGaugeChart = function RadialGaugeChart(Chart$$1) {
  ...
  /***/
  function node_modulesChartjsPluginLabelsSrcChartjsPluginLabelsJs(module, exports) {
    /**
        ...
        if (typeof label === 'string') {
          ...
          for (var j = 0; j < lines.length; ++j) {
            ...
            for (var i = 0; i < line.length; i++) {
              ...
              mertrics = ctx.measureText(_char);
              ctx.save();
              ctx.translate(0, -1 * radius);
              ctx.fillText(_char, 0, y);
              ctx.restore();
  ...
  /***/
  function node_modulesChartjsTsgaugeGaugeJs(module, exports) {
    (function () {
      if (!window.Chart) {
        return;
      }
      ...
      Chart.controllers.tsgauge = Chart.controllers.doughnut.extend({
        initialize: function initialize(chart) {
...
//# sourceMappingURL=default~pages-history-history-module~pages-summary-summary-module-es5.js.map