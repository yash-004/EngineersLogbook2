...
require("chartjs-tsgauge"); //Chart.defaults.global.defaultFontSize = 10;
...
function () {
  ...
  SummaryPage.prototype.checkOperatordaysCurrencyValid = function (date, vehicletype) {
    var today = dayjs(); //var period = vehicletype==="BELREX" ? 30 : 7;
  ...
  __decorate([core_1.ViewChild("chartCanvas2", {
    "static": true
  })], SummaryPage.prototype, "chartCanvas2");

  __decorate([core_1.ViewChild("chartCanvas1", {
    "static": true
  })], SummaryPage.prototype, "chartCanvas1");

  __decorate([core_1.ViewChild("chartCanvas4", {
    "static": true
  })], SummaryPage.prototype, "chartCanvas4");

  __decorate([core_1.ViewChild("chartCanvas3", {
    "static": true
  })], SummaryPage.prototype, "chartCanvas3");

  __decorate([core_1.ViewChild("chartCanvas5", {
    "static": true
  })], SummaryPage.prototype, "chartCanvas5");

  SummaryPage = __decorate([core_1.Component({
